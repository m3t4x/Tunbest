...
export default class Dashboard extends Component {
  ...
  getProduct = () => {
    ...
    axios.get(`http://localhost:2000/get-movie${data}`, {
      headers: {
  ...
  deleteProduct = (id) => {
    axios.post('http://localhost:2000/delete-movie', {
      id: id
    }, {
      headers: {
  ...
  addProduct = () => {
    ...
    axios.post('http://localhost:2000/add-movie', file, {
      headers: {
  ...
  updateProduct = () => {
    ...
    axios.post('http://localhost:2000/update-movie', file, {
      headers: {
        'content-type': 'multipart/form-data',
        'token': this.state.token
      }
  ...
  render() {
    return (
      <div>
        ...
        >
          <DialogTitle id="alert-dialog-title">Edit Movie</DialogTitle>
          <DialogContent>
            <TextField
              id="standard-basic"
              type="text"
